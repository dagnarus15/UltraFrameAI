...
public static class LocalizedStrings
{
    ...
    public static string RealEsrganAnimeHint => GetText(nameof(RealEsrganAnimeHint));
    ...
    public static string HardwareVramBenchmarkMinimumDetail => GetText(nameof(HardwareVramBenchmarkMinimumDetail));
    public static string HardwareVramBenchmarkEnoughDetail => GetText(nameof(HardwareVramBenchmarkEnoughDetail));
    public static string HardwareVramBenchmarkLowDetail => GetText(nameof(HardwareVramBenchmarkLowDetail));
    ...
    public static string HardwareRamBenchmarkMinimumDetail => GetText(nameof(HardwareRamBenchmarkMinimumDetail));
    public static string HardwareRamBenchmarkEnoughDetail => GetText(nameof(HardwareRamBenchmarkEnoughDetail));
    public static string HardwareRamBenchmarkLowDetail => GetText(nameof(HardwareRamBenchmarkLowDetail));
